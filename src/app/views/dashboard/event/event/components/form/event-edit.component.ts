      ...
      <div class="responsive-table">
          <table class="table table-lg table-hover table-striped table-sm">
              ...
              <tr *ngFor="let v of tuitions ; let i=index">
                  <th scope="row">{{i + 1}}</th>
                  <td data-title="Código">{{v.persona?.codigo}}</td>
                  <td data-title="DNI">{{v.persona?.dni}}</td>
                  <td data-title="Nombres">{{v.persona?.nombres}}</td>
                  <td data-title="Ciclo">{{v.persona?.ciclo}}</td>
                  <td data-title="Grupo">{{v.persona?.grupo}}</td>
                  <td data-title="Institucion">{{v.persona?.escuelaProfesional!.facultad!.filial!.institucion!.descripcion!}}</td>
                  <td data-title="Filial">{{v.persona?.escuelaProfesional!.facultad!.filial!.descripcion!}}</td>
                  <td data-title="Facultad">{{v.persona?.escuelaProfesional!.facultad!.descripcion!}}</td>
                  <td data-title="E.P.">{{v.persona?.escuelaProfesional!.descripcion!}}</td>
                  <td data-title="Estado">
                        <span class="badge text-bg-{{v.persona?.estado?'success': 'danger'}} text-white">
                            {{v.persona?.estado ? 'Activo' : 'Inactivo'}}
                        </span>
                  </td>
...
export class EventEditComponent implements OnInit {
  ...
  public eventPathValue(event: Event): void {
    ...
    this.eventForm.patchValue({
      institucionId: event.escuelaProfesional?.facultad?.filial?.institucion?.id,
      filialId: event.escuelaProfesional?.facultad?.filial?.id,
      facultadId: event.escuelaProfesional?.facultad?.id,
      escuelaProfesionalId: event.escuelaProfesional?.id,
    });
  ...
  public saveForm(): void {
    ...
    this.tuitions.map(data => {
        ...
        dataPerson.persona = {id: data.persona?.id};
